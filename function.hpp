...
enum typeTest {M_INT, M_NAME, M_ADDR, M_TEL, M_UR, M_IND, M_TYPE_CL};

enum mainMenu {ADD_MENU = 1, MODIF, REMOV, PRINT};
enum addMenu {ADD_COMPANI= 1, ADD_COPY_CL, ADD_COPY_COM, ADD_UR_CLIENT, ADD_IND_CLIENT};
enum modMenu {MOD_CLIENT = 1, MOD_COMP};
enum removMenu {REMOV_CL = 1, REMOV_CL_ALL, REMOV_CM, REMOV_CM_ALL};
enum typeClient {UR_CL = 1, IND_CL};
